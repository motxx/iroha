...
if (NOT GRPC_FOUND)
  externalproject_add(grpc_grpc
      ...
      BUILD_COMMAND ${CMAKE_COMMAND} -E env HAS_PKG_CONFIG=false PROTOC=${Protobuf_protoc_EXECUTABLE}\ -I${Protobuf_INCLUDE_DIR} PATH=${Protobuf_protoc_EXECUTABLE_DIR}:$ENV{PATH} LDFLAGS=-L${Protobuf_LIBRARY_DIR} CFLAGS=-I${Protobuf_INCLUDE_DIR} CPPFLAGS=-I${Protobuf_INCLUDE_DIR} LD_LIBRARY_PATH=${Protobuf_LIBRARY_DIR}:$ENV{LD_LIBRARY_PATH} $(MAKE)
